...
public class StripeBridge extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void createPayment(String clientSecret, String cc, String month, String year, String cvc, Callback successCallback){
    Activity activity = reactContext.getCurrentActivity();
    CardInputWidget cardInputWidget = activity.findViewById(R.id.cardInputWidget);
